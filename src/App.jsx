  ...
  return (
    <div className="font-biennale">
      <Routes>
        ...
        <Route
          path="/"
          element={<ExternalRedirect url="https://www.writtenlyhub.com" />}
        />
        ...
        <Route
          path="/contentengine-healthcare"
          element={<ContentEngineHealthcare />}
        />
        <Route
          path="/contentengine-fintech"
          element={<ContentEngineFinTech />}
        />
