...
const HowItWorks = () => {
  ...
  const steps = [
    {
      title: "Getting to know your mission",
      description: "We dive deep into your nonprofit's story, values, and the change you're creating in the world."
    },
    {
      title: "Researching your competitors",
      description: "We analyze what other nonprofits are doing to attract grants and donors, finding your unique opportunity."
    },
    {
      title: "Analyzing your content brief",
      description: "Send us your campaign goals, audience details, and content requirements through our simple request system."
    },
    {
      title: "Amplifying your stories",
      description: "Our nonprofit writers transform program outcomes into compelling narratives that inspire support and action."
    },
    {
      title: "Creating SEO & GEO-friendly content",
      description: "Our nonprofit content team crafts donor-focused pieces that align with your mission and drive conversions."
    },
    {
      title: "Reviewing the copy",
      description: "Get your content back in 2-3 days. Request unlimited revisions until it's perfect for your nonprofit."
    },
    {
      title: "Publishing for reach",
      description: "Publish consistently while we handle your next content requests. Focus on your mission, not content creation."
    },
    {
      title: "Growing what works",
      description: "We continuously refine content based on donor engagement metrics, maximizing your mission's reach and response."
    }
  ];
    ...
    <section ref={containerRef} className="font-montserrat relative w-full bg-[#022150] py-24 overflow-hidden">
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          From brief to published: <span className="text-orange-500 ">How our nonprofit content agency works</span>
        </h2>
      </motion.div>
