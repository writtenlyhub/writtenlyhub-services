    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          <span className="text-orange-500">Save $200K on content,</span> while 3x'ing your nonprofit marketing results
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Stop burning budget on freelancer roulette. Get unlimited donor-converting content for a flat monthly fee.
        </motion.p>
