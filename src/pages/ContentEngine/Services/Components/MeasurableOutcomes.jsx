    ...
    <section className="font-montserrat relative w-full bg-[#022150] py-12 md:py-20 overflow-hidden">
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          <span className="text-orange-500">What you're missing </span>while you decide
        </h2>
        <p className="text-gray-300 max-w-2xl mx-auto text-xl">
          Every month without consistent content marketing costs your nonprofit: 
        </p>
      </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            <div className="space-y-8">
              {[
                "12,000+ potential website visitors who never discover your mission ",
                "$200,000+ in lost donations from donors who can't find recent impact stories ",
                "200+ email subscribers your competitors gain while your list stagnates ",
                "50+ ranking opportunities your nonprofit could own on Google & AI tools like ChatGPT "
              ].map((point, index) => (
