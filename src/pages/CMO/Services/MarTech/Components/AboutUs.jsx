...
const AboutUs = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Your dev team will finally respect your marketing.",
      ...
      <div className="w-[90%] md:w-[80%] mx-auto font-montserrat">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-xl">
            WrittenlyHub partners with MarTech founders that keep asking: "Why
            doesn't our marketing team understand our product?"
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-300 text-lg md:text-xl max-w-4xl mx-auto">
            We're the answer to that question. Our experienced content team
            begins with deep technical discovery, we analyze your platform,
            dissect your product architecture, and scrutinize your competition
            to find what's actually worth amplifying.
          </p>
          <p className="max-w-5xl pt-2 text-orange-500 mx-auto text-xl">
            We obsess over the "why" before we ever write the "how."
          </p>
        </motion.div>
