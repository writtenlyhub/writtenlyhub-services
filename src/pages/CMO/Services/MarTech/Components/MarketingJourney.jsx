...
const MarketingJourney = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Buckle up: We quiz your engineers for hours about YOUR goals and vision before touching any marketing materials.",
    },
    {
      title: "Competitor forensics",
      description:
        "We reverse-engineer your rivals' strategies, then exploit their technical blind spots to position you as the clear winner.",
    },
    {
      title: "Message architecture",
      description:
        "Say goodbye to spray-and-pray tactics. We map your features to customer outcomes. Every integration explained.",
    },
    {
    ...
    },
    {
      ...
      description:
        "We deploy, measure what matters, and optimize for implementation.",
    },
  ];
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          Your end-to-end{" "}
          <span className="text-orange-500 ">marketing launchpad</span>
        </h2>
