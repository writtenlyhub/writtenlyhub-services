...
const MarketingJourney = () => {
  ...
  const steps = [
    {
      title: "Reality audit",
      description: "We become power users of your platform. No shortcuts."
    },
    {
      title: "Engineering interrogation",
      description: "Buckle up: We quiz your engineers for hours about YOUR goals and vision before touching any marketing materials."
    },
    {
      title: "Competitor forensics",
      description: "We reverse-engineer your rivals' strategies, then exploit their technical blind spots to position you as the clear winner."
    },
    {
      title: "Message architecture",
      description: "Say goodbye to spray-and-pray tactics. We map your features to customer outcomes. Every integration explained."
    },
    {
      title: "Content creation",
      description: "We write copy that your engineers actually approve of."
    },
    {
      title: "Launch and iterate",
      description: "We deploy, measure what matters, and optimize for implementation."
    }
  ];
  ...
  return (
    <section ref={containerRef} className="font-montserrat relative w-full bg-[#022150] py-12 md:py-20 overflow-hidden">
      ...
      >
          ...
          Your end-to-end <span className="text-orange-500 ">marketing launchpad</span>
        </h2>
