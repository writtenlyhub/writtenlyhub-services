...
const stats = [
  { id: 1, name: 'Generated', value: 14000000 }, // 14 million
  { id: 2, name: 'Brands Elevated', value: 8 },
  { id: 3, name: 'Faster Adoption', value: 53, isPercentage: true },
  { id: 4, name: 'Higher Demo Rates', value: 37, isPercentage: true },
];
...
const Counter = ({ value, isPercentage = false }) => {
  ...
  return <span ref={ref} className="text-orange-500 font-bold">{formatted}{!isPercentage && '+'}</span>;
};
          ...
          {stats.map((stat, index) => (
            ...
            >
              <p className="text-2xl md:text-3xl font-bold text-white mb-1">
                <Counter value={stat.value} isPercentage={stat.isPercentage} />
              </p>
