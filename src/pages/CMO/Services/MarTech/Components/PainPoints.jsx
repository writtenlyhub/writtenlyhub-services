...
const painPoints = [
  {
    text: "Our dev team pushes 3 releases a week. Our marketing hasn't updated since launch.",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "Marketing celebrates MQLs while sales screams that nobody understands what we actually do.",
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "Prospects love our demo but can't explain our value to their boss.",
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Developers get it instantly. Decision-makers need a translator.",
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "Our webhook documentation is clearer than our homepage.",
   ...
   <motion.div
        ...
        >
          <div className="text-center">
            ...
            <span className="text-orange-500 block">The MarTech marketing problem</span> every founder recognizes
            </h2>
