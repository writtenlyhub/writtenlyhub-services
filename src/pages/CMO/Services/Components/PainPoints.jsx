...
const painPoints = [
  {
    text: "Followed every webinar but still no growth.",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "My sales team is doubling as the marketing department. Both are suffering.",
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "We have 8 marketing tools zero bandwidth to use them effectively.",
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Marketing celebrates lead volume while sales complain about lead quality.",
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "I have to ask, 'where do you see yourself in 5 years' questions every 2 months.",
   ...
   <motion.div
        ...
        >
          <div className="text-center">
            ...
            The (brutal) honesty about <span className="text-orange-500">SaaS marketing</span>
            </h2>
