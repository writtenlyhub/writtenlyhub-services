  ...
  const steps = [
    {
      title: "Tech audit",
      description:
        "We dig into what's working, what's flopping, and what you think is working (but isn't).",
    },
    {
      title: "Understanding you",
      description:
        "Heads up: We spend hours asking questions about YOUR company before starting.",
    },
    {
      title: "Competitor analysis",
      description:
        "We stalk your rivals then use their gaps to make you look like the obvious choice.",
    },
    {
      title: "Setup",
      description:
        "We Marie Kondo your marketing mess by plugging the right tools and ditching the chaos so execution's a breeze.",
    },
    {
      title: "Content strategy",
      description:
        "No more posting and praying. We craft a content game plan that hits goals, not just 'likes'.",
    },
    {
      title: "Execute & analyze",
      description:
        "We don't just press 'go.' We launch, obsess over numbers, and tweak till the magic happens.",
    },
    {
      title: "Scale what's working",
      description:
        "If it's hot, we double down. If it's not, we ghost it. That's how you scale with style.",
    },
  ];
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          Journey to improving your{" "}
          <span className="text-orange-500 block">B2B SaaS marketing</span>
        </h2>
