...
const AboutUs = () => {
  const features = [
    ...
    },
    {
      ...
      description: "We keep the complexity intact while making it engaging for laymen—no dumbing down, just smarter storytelling.",
    ...
    },
    {
      ...
      description: "We cut through the marketing BS and say what needs to be said, nothing more, nothing less.",
      ...
      <div className="w-[90%] md:w-[80%] mx-auto font-montserrat">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">
            WrittenlyHub: <span className="text-orange-500">Content, not chaos</span>
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto text-xl">
            Surface-level content kills products with great potential, WrittenlyHub is here to honor your excellence.            
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-300 text-lg md:text-xl max-w-4xl mx-auto">
            Here, we're not just another content agency churning out blog posts for the algorithm gods. We're known for our obsessive research, refusal to oversimplify complex subjects, and ability to make technical excellence marketable without compromising its integrity.           
          </p>
