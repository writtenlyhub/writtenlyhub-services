...
const painPoints = [
  {
    text: "We're competing with Amazon Prime for donor attention spans.",
    image: "https://i.ibb.co/cXXDGQg8/1.png",
  },
  {
    text: "Our impact stories sound like grant reports, not inspiration.",
    image: "https://i.ibb.co/R4GvKWx3/2.png",
  },
  {
    text: "Major donors give once then disappear forever.",
    image: "https://i.ibb.co/8ghycmd3/3.png",
  },
  {
    text: "Board members keep asking why we can't 'go viral' like that ice bucket thing.",
    image: "https://i.ibb.co/S4KkBJQC/4.png",
  },
  {
    text: "We spend more time explaining our programs than running them.",
          ...
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mt-2 md:mt-3 mb-3 md:mb-4">
              <span className="text-orange-500 ">
                The nonprofit marketing struggles
              </span>{" "}
              every ED recognizes
            </h2>
