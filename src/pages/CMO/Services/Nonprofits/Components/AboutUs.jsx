  ...
  const features = [
    {
      ...
      description:
        "We study your programs and initiatives before writing your campaigns.",
    ...
    },
    {
      ...
      title: "Donor focused",
      description: "We optimize for recurring gifts, not one-time donations.",
    ...
    },
    {
      ...
      description:
        "Every campaign designed to build long-term donor relationships. ",
      ...
      <div className="w-[90%] md:w-[80%] mx-auto font-montserrat">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">
            ...
            <span className="text-orange-500">
              that learns your mission first
            </span>
          </h2>
          <p className="text-gray-300 max-w-3xl mx-auto text-xl">
            WrittenlyHub dives deep into understanding your cause, analyzing
            your donor base, and grasping your unique challenges before creating
            any campaigns.
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-300 text-lg md:text-xl max-w-4xl mx-auto">
            Unlike marketing agencies that treat nonprofits like "businesses
            with a heart," we study your programs, understand your funding
            cycles, and respect the complexity of mission-driven work.
          </p>
          <p className="max-w-3xl pt-2 text-orange-500 mx-auto text-xl">
            We create marketing that builds donor trust, campaigns that drive
            sustainable funding, and storytelling that honors your impact.
          </p>
        </motion.div>
