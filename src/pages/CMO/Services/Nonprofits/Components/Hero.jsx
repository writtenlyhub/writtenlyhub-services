      ...
      >
        ...
        >
          <span className="text-orange-500  sm:inline ">
            Nonprofit CMO-as-a-Service{" "}
          </span>
          that actually understands donor psychology
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          We handle your entire marketing operation while you focus on
          initiatives. Built by professionals who understand NPO storytelling.
        </motion.p>
