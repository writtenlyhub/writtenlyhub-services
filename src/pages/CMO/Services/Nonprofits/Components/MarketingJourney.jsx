...
const MarketingJourney = () => {
  ...
  const steps = [
    {
      title: "Nonprofit audit",
      description:
        "We assess your current efforts against actual nonprofit best practices. The gaps might surprise you.",
    },
    {
      title: "Mission deep dive",
      description:
        "We immerse ourselves in YOUR cause, values, and exactly why your mission matters to the world.",
    },
    // {
    ...
    // },
    {
      ...
      description:
        "We study how others in your space engage donors, then find untapped opportunities for your organization.",
    },
    {
      title: "Marketing system streamlining",
      description:
        "We consolidate tools, eliminate waste, and create simple systems that your team can actually manage.",
    },
    {
      title: "Mission-aligned messaging",
      description:
        "We craft stories that speak to donors, volunteers, and stakeholders in ways that move them to action.",
    },
    {
      title: "Campaign launch & optimization",
      description:
        "We test authentic content, measure real impact, and refine until donations and engagement soar.",
    },
    {
      title: "Impact amplification",
      description:
        "We identify what drives results, then scale those proven tactics to reach more people for your cause.",
    },
  ];
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          <span className="text-orange-500 block">
            Marketing stress → mission success:{" "}
          </span>
          Our proven path
        </h2>
                      ...
                      <motion.div
                        ...
                        style={{
                          ...
                          backgroundColor: useTransform(
                            cardActiveState,
                            [0, 1],
                            ["rgba(2, 33, 80, 1)", "rgba(2, 33, 80, 0.9)"]
                          ),
                        }}
                      >
                        {/* Animated glow border overlay */}
