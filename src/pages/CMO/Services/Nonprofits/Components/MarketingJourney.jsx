...
const steps = [
  {
    ...
    description: "We assess your current efforts against actual nonprofit best practices. The gaps might surprise you."
  },
  {
  ...
  },
  {
    ...
    description: "We consolidate tools, eliminate waste, and create simple systems that your team can actually manage."
  },
  {
    title: "Mission-aligned messaging",
    description: "We craft stories that speak to donors, volunteers, and stakeholders in ways that move them to action."
  },
  {
    title: "Campaign launch & optimization",
    description: "We test authentic content, measure real impact, and refine until donations and engagement soar."
  },
    {
    title: "Impact amplification",
    description: "We identify what drives results, then scale those proven tactics to reach more people for your cause."
  }
];
