...
const USP = () => {
  const sellingPoints = [
    "Your nonprofit dream team, not a consultant burning donor funds.",
    "Built by ex-development folks, not Google-certified 'nonprofit experts.'",
    "We track real engagement, not vanity metrics no one cares about.",
    "Zero tolerance for 'just run some Facebook ads' conversations. We're way beyond that.",
    "Understanding that your mission is not a B2B sales pitch. Your cause deserves better.",
  ];
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-6 sm:p-8 md:p-12 flex-1">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-8 leading-tight">
                Marketing that<span className="text-orange-500 block sm:inline"> honors your mission </span>
              </h2>
