...
const ValueProposition = () => {
  ...
  const items = [
    ...
    {
      title: "Plug-and-play partnership",
      points: [
        "We plug in, not take over",
        "Mission drives every choice",
        "Nonprofit-ready deliverables",
      ],
    },
  ];
            ...
            >
              ...
              >
                ...
                <span className="text-orange-500 block">
                  {" "}
                  meets strategic marketing prowess{" "}
                </span>
              </h2>
              ...
              >
                Mission alignment + marketing muscle - the corporate overhead =
                strategic marketing extension your fundraising deserves.
              </p>
