      ...
      <div className="w-[90%] md:w-[80%] mx-auto font-montserrat">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">
            The marketing team{" "}
            <span className="text-orange-500">that speaks your language</span>
          </h2>
          <p className="text-gray-300 max-w-3xl mx-auto text-xl">
            Wikipedia is not research. WrittenlyHub knows better. <br /> Our
            team digs deep into your industry, dissecting your competition and
            understanding your technical complexities before writing a single
            word. Unlike content factories that prioritize speed over substance.
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-300 text-lg md:text-xl max-w-4xl mx-auto">
            We're obsessed with accuracy and refuse to dumb down sophisticated
            concepts.
          </p>
          <p className="max-w-3xl pt-2 text-orange-500 mx-auto text-xl">
            We create content that technical teams approve and decision-makers
            trust; 2-3x higher engagement, technical integrity intact.
          </p>
        </motion.div>
