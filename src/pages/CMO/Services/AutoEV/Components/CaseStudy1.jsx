          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-6 md:p-8 lg:p-10 flex-1 flex flex-col justify-center gap-2">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
                How we turned Zeffy's free payment platform into the obvious
                choice
              </h3>
              ...
              <p className="text-white/80 text-lg mb-4">
                ...
                Zeffy processes payments for free (yes, really). But "free" made
                prospects suspicious. <br />
                <span className="font-semibold text-orange-500">
                  Our approach:
                </span>{" "}
                We repositioned free as their competitive moat, not a red flag.
              </p>
