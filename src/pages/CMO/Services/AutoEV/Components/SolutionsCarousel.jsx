  ...
  const items = [
    {
      ...
      points: [
        ...
        "Subsidy hunting experts",
        "Supply chain content pros",
      ],
    },
    {
      title: "Full-throttle execution",
      points: [
        "Campaign management",
        "Technical yet simple content that converts",
        "Multi-channel automotive marketing expertise",
      ],
    },
    {
      title: "Growth investors notice",
      points: [
        "Pilot-to-contract ratios",
        "Strategic alliance metrics",
        "Fundable performance data",
      ],
    },
    {
      title: "Plug-and-play marketing",
      points: [
        "Hit the ground running",
        "One team, one contact",
        "Auto-specific deliverables",
      ],
    },
  ];
      ...
      cardsRef.current.forEach((card, index) => {
        ...
        if (isActive) {
          ...
          const rotation = isMobile
            ? 0
            : cardRotations[index % cardRotations.length]; // No rotation on mobile
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Strategic thinking? Check. Hands-on execution? Double check. Get
                CMO expertise delivering real results.
              </p>
            ...
            >
              <div
                className={`relative w-full ${
                  isMobile ? "max-w-sm h-[20rem]" : "max-w-xl h-[24rem]"
                } flex items-center justify-center`}
              >
                {items.map((item, i) => (
                  <div
                  ...
                  >
                    <div
                      className={`bg-white border border-gray-200 rounded-xl ${
                        isMobile ? "p-6" : "p-8"
                      } w-full h-full shadow-2xl flex flex-col justify-center`}
                    >
                      <div className="w-full">
                        <div className="flex items-center mb-4 md:mb-6">
                          <span className="text-orange-500 text-2xl md:text-3xl font-bold mr-2">
                            #{i + 1}
                          </span>
                          <h3
                            className={`${
                        ...
                        <ul className="space-y-3 md:space-y-4">
                          {item.points.map((point, index) => (
                            <li key={index} className="flex items-start">
                              <span className="text-orange-500 text-xl md:text-2xl mr-3">
                                •
                              </span>
