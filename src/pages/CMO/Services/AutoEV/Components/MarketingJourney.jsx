...
const steps = [
    {
      title: "Automotive reality check",
      description: "We assess your current marketing versus actual automotive expertise. You might be surprised."
    },
    {
      title: "Discovering you",
      description: "We learn about YOUR tech, goals, and exactly why other agencies don't get it first."
    },
    {
      title: "Competitive intelligence",
      description: "We study how rivals position themselves, then find openings for your brand to dominate."
    },
    {
      title: "Marketing infrastructure overhaul",
      description: "We simplify your tech stack, eliminate redundancies, and set up systems that work."
    },
    {
      title: "Targeted messaging development",
      description: "We create content that speaks to fleet managers, regulators, and investors in their language."
    },
    {
      title: "Growth amplification",
      description: "We identify what's generating pilots and partnerships, then scale those tactics hard."
    }
  ];
  ...
  return (
    <section ref={containerRef} className="font-montserrat relative w-full bg-[#022150] py-12 md:py-20 overflow-hidden">
      ...
      >
          ...
          Your path from marketing <span className="text-orange-500 block">confusion to market dominance</span>
        </h2>
