          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-6 md:p-8 lg:p-10 flex-1 flex flex-col justify-center gap-2">
              ...
              <p className="text-white/80 text-lg mb-4">
                ...
                The 133% increase in impressions, coupled with a 55-97% CTR
                across most posts and a steady rise in followers, indicates that
                our content is reaching more people, increasing in visibility
                and engagement.
              </p>
