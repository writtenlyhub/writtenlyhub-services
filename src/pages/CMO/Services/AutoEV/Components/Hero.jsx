      ...
      >
        ...
        >
          <span className="text-orange-500  sm:inline ">
            Stop losing fleet deals because{" "}
          </span>
          your EV pitch sounds like everyone else's
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Automotive innovators: Your technology is game-changing. Your
          marketing makes it sound generic.
        </motion.p>
