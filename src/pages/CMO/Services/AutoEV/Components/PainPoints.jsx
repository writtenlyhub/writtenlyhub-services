...
const painPoints = [
  {
    text: "Great, another agency that thinks EVs are just cars with batteries...",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "Fleet managers hang up when we sound like every other EV out there!.",
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "Pilot programs love our demos but never convert to contracts.",
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Our pitch deck screams 'startup' instead of 'industry partner.'",
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "Zero strategic partnerships because our deck screams 'garage startup'.",
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mt-2 md:mt-3 mb-3 md:mb-4">
              What keeps
            <span className="text-orange-500 "> auto CMOs up at night </span>
            </h2>
