  ...
  const steps = [
    {
      ...
      description:
        "We dig into your startups' marketing mess, identify what's actually working (spoiler: usually not much).",
    },
    {
      title: "Getting intimate",
      description:
        "We spend time learning your portfolio's unique needs, funding stages, and investor expectations first.",
    },
    {
      title: "Competitor stalking",
      description:
        "We analyze what other incubators do wrong so your portfolio stands out like the obvious choice.",
    },
    {
      title: "Marketing detox",
      description:
        "We organize your portfolio's marketing chaos with proper systems, tools, and processes that actually work.",
    },
    {
      title: "Strategic plotting",
      description:
        "Custom marketing plans for each startup stage - from seed to Series A and beyond.",
    },
    {
      title: "Launch & obsess",
      description:
        "We launch campaigns, obsess over metrics that matter to investors, and tweak until growth happens.",
    },
    {
      title: "Scale like crazy",
      description:
        "What's working gets amplified across the portfolio. What's not gets ditched. Growth with zero waste.",
    },
  ];
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          ...
          <span className="text-orange-500 block">
            portfolio into growth machines{" "}
          </span>
        </h2>
