...
const ValueProposition = () => {
  ...
  const items = [
    ...
    {
      title: "Full execution, zero hassle",
      points: [
  ...
  return (
    ...
    >
      <div className="w-[90%] md:w-[80%] mx-auto max-w-7xl">
          ...
          >
            ...
            >
              ...
              >
                ...
                over agencies and in-house teams
              </h2>
              ...
              >
                Stop hiring headaches. Get senior-level marketing expertise for
        ...
        <div
          className={`absolute ${
            isMobile ? "bottom-10" : "bottom-12 lg:bottom-8"
