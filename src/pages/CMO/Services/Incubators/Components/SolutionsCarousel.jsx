...
Stop hiring headaches. Get senior-level marketing expertise for a fraction of the cost. 
              </p>
        ...
        {/* CTA */}
        <div className={`absolute ${isMobile ? 'bottom-10' : 'bottom-12 lg:bottom-8'} left-1/2 transform -translate-x-1/2 text-center pt-4 lg:pt-16 z-30`}>
          <a
