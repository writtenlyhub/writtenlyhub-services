          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-6 md:p-8 lg:p-10 flex-1 flex flex-col justify-center gap-2">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
                How we made GrowthJockey's portfolio visibility impossible to
                ignore
              </h3>
              ...
              <p className="text-white/80 text-lg mb-4">
                ...
                GrowthJockey needed to establish authority as a startup
                incubator and attract high-quality portfolio companies seeking
                scaling support.
                <br />
                <span className="font-semibold text-orange-500">
                  Our approach:
                </span>{" "}
                We positioned them as the technical incubator that understands
                both enterprise partnerships and startup growth challenges.
              </p>
...
const StatItem = ({ icon, label, value }) => (
  <div className="flex items-start">
    <div className="bg-orange-500/10 p-2 rounded-lg mr-3 sm:mr-4">{icon}</div>
    <div>
      <p className="text-gray-300 text-xs sm:text-sm uppercase tracking-wider mb-1">
        {label}
      </p>
