          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-6 md:p-8 lg:p-10 flex-1 flex flex-col justify-center gap-2">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
                How we made GrowthJockey's portfolio visibility impossible to ignore
              </h3>
              
              <p className="text-white/80 text-lg mb-4">
                <span className="font-semibold text-orange-500">The challenge:</span> GrowthJockey needed to establish authority as a startup incubator and attract high-quality portfolio companies seeking scaling support.<br />
                <span className="font-semibold text-orange-500">Our approach:</span> We positioned them as the technical incubator that understands both enterprise partnerships and startup growth challenges.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4">
                ...
                <StatItem 
                  ...
                  label="Portfolio Attraction"
                  value="3x applications"
                />
              </div>
            ...
            <div className="md:w-[40%] lg:w-[35%] bg-gradient-to-br from-orange-500/10 to-blue-500/10 flex items-center justify-center p-4 sm:p-6">
              <img 
                src="https://i.ibb.co/9k9DGYxW/Untitled-design-41.png" 
                alt="GrowthJockey's impressive traffic growth analytics"
