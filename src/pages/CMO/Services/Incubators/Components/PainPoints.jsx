...
const painPoints = [
  {
    text: "Half our portfolio has brilliant tech and terrible positioning.",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "LPs want to see marketing traction across companies, not just product progress." ,
  ...
  {
    text: "Demo days are coming and our companies sound like everyone else." ,
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "Portfolio companies need consistent branding but we can't manage 30 agencies." ,
   ...
   <motion.div
        ...
        >
          <div className="text-center">
            ...
            <span className="text-orange-500 "> challenges every MD knows</span>
            </h2>
