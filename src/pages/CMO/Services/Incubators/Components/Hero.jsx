      ...
      >
        ...
        >
          <span className="text-orange-500  sm:inline ">
            Your portfolio companies need marketing.
          </span>{" "}
          You don't have 30 marketing budgets.
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Get fractional CMO expertise for your entire portfolio at 70% less
          cost than hiring individual marketing teams.
        </motion.p>
        <motion.p
          variants={fadeInUp}
          className="text-white/90 text-lg sm:text-xl mb-6 text-left w-[80%]"
