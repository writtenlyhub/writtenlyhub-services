...
const AboutUs = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "We manage marketing across multiple startups simultaneously. ",
    ...
    },
    {
      ...
      title: "Systematic scaling",
      description:
        "Consistent processes and branding across your entire portfolio. ",
      image: focus,
    },
    {
      icon: (
    ...
    },
    {
      ...
      description:
        "Every campaign optimized for next funding milestone metrics. ",
    ...
    },
    {
      ...
      description:
        "Marketing materials that impress LPs and potential investors.",
      ...
      <div className="w-[90%] md:w-[80%] mx-auto font-montserrat">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">
            The marketing team{" "}
            <span className="text-orange-500">built for portfolio scaling</span>
          </h2>
          <p className="text-gray-300 max-w-3xl mx-auto text-xl">
            WrittenlyHub exists because incubator partners kept asking: "How do
            we get consistent marketing across 30+ startups without 30+
            marketing budgets?"
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-300 text-lg md:text-xl max-w-4xl mx-auto">
            We solve the portfolio marketing scaling problem. One team, multiple
            companies, systematic growth.
          </p>
          <p className="max-w-3xl pt-2 text-orange-500 mx-auto text-xl">
            We study each startup's unique value proposition, create
            portfolio-wide systems that work, and deliver marketing that helps
            companies hit their next funding milestones.
          </p>
        </motion.div>
