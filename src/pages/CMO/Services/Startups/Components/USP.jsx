...
const USP = () => {
  const sellingPoints = [
    "We become your marketing team, not just another agency on retainer ",
    "Fraction of a CMO salary (>70%) with a sh*tload more expertise and experience ",
    "MFull ownership of strategy + execution while you stay in your genius zone ",
    "Revenue-focused approach because 'brand awareness' doesn't pay the bills ",
    "Measurable results only. No 'building brand equity' cop-outs "
  ];
