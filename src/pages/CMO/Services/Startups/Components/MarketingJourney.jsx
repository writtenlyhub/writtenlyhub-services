  ...
  const steps = [
    {
      ...
      description:
        "We dig into what's working, what's broken, and what you think is working (spoiler: it probably isn't).",
    },
    {
      title: "Get to know your seedling",
      description:
        "We spend actual time learning YOUR business, not copy-pasting from our last client.",
    },
    {
      title: "Competitor stalking",
      description:
        "We analyze what your rivals are doing wrong so we can make you look like the obvious choice.",
    },
    {
      title: "System setup",
      description:
        "We Marie Kondo your marketing tools—keep what works, ditch what doesn't, add what you need.",
    },
    {
      title: "Strategy that sells",
      description:
        "Content plans with actual purpose. No more posting random sh*t and hoping.*",
    },
    {
      title: "Launch and optimize",
      description:
        "We don't just hit publish and pray. We launch, track religiously, and tweak until it works.",
    },
    {
      title: "Scale the winners",
      description:
        "If it's making money, we double down. If it's not, we kill it. No emotional attachments.",
    },
  ];
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          ...
          <span className="text-orange-500 block">
            "WTF is happening?" to "HELL YES, that works!"
          </span>
        </h2>
