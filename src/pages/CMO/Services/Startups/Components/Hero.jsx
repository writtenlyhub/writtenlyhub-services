      ...
      >
        ...
        >
          <span className="text-orange-500  sm:inline ">
            Stop hiring marketing people{" "}
          </span>
          who don't understand startups
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Get a fractional CMO who's been through the chaos. We handle strategy
          + execution while you focus on building something people actually
          want.
        </motion.p>
