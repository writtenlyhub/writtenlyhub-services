...
What we offer
               ...
               What you get 
                <span className="text-orange-500 block"> (no smoke and mirrors)  </span>
              </h2>

              <p className={`${isMobile ? 'text-lg' : 'text-xl'} text-white mb-6 md:mb-8`}>
Here's the thing: Most startups fail at marketing because they're trying to do everything at once with zero strategy.                </p>
