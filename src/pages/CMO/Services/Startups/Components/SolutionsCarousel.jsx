...
const ValueProposition = () => {
  ...
  const items = [
    {
      title: "CMO expertise, minus the ego",
      points: [
    ...
    },
    {
      ...
      points: [
        "Actually engaging copy",
        "Platform-specific optimization",
        "No generic AI slop",
        "Content your competitors wish they had",
      ],
    },
    {
      ...
      points: [
        ...
        "Tech stack that talks to itself",
        "Systems that work while you sleep",
      ],
    },
    {
      title: "Results worth bragging about",
      points: [
        "Revenue-focused metrics",
        "Weekly performance tracking",
        "Data-driven optimization",
        "Growth that shows in your bank account",
      ],
    },
  ];
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Here's the thing: Most startups fail at marketing because
                they're trying to do everything at once with zero strategy.{" "}
              </p>
