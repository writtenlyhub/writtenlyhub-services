  ...
  const features = [
    {
      ...
      description:
        "We optimize for metrics that matter to investors, not vanity. ",
    ...
    },
    {
      ...
      description:
        "We speak runway, not retainer. No explaining why CAC matters. ",
    ...
    },
    {
      ...
      description:
        "Strategy plus hands-on work. No 'here's your plan, good luck.' ",
      image: focus,
    },
    {
      icon: (
      ...
      <div className="w-[90%] md:w-[80%] mx-auto font-montserrat">
        ...
        >
          ...
          <p className="text-gray-300 max-w-3xl mx-auto text-xl">
            Generic content is where good companies go to die. WrittenlyHub
            exists to save you from that fate.
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-300 text-lg md:text-xl max-w-4xl mx-auto">
            While other agencies churn out templated garbage and call it
            "strategy," we're obsessed with understanding what makes your
            business actually unique. We dig into the stuff they're too lazy to
            research and create marketing that honors your intelligence.{" "}
          </p>
          <p className="max-w-3xl pt-2 text-orange-500 mx-auto text-xl">
            We think deeper, execute smarter, and refuse to make you sound like
            every other company begging for attention.
          </p>
        </motion.div>
