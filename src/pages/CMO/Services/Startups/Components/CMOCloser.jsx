...
const CMOCloser = () => {
  ...
  Stop wasting runway on marketing that doesn't work
          </h3>

          <p className="text-white text-xl md:text-2xl mb-6 max-w-2xl mx-auto">
  While you're figuring out Facebook ads, your competitors are building scalable growth engines.
          </p>
          <p className="text-white text-xl md:text-2xl mb-6 max-w-2xl mx-auto">
  Every month you wait is another month of burned cash and missed opportunities.
