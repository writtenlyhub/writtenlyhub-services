    ...
    <section className="font-montserrat relative w-full bg-[#022150] py-12 md:py-20 overflow-hidden">
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          <span className="text-orange-500">The content growth you're missing </span>while you hesitate
        </h2>
        <p className="text-gray-300 max-w-2xl mx-auto text-xl">
          Every quarter without consistent content marketing costs your B2B SaaS: 
        </p>
      </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            <div className="space-y-8">
              {[
                "450+ potential customers who never discover your product exists",
                "$180,000+ (MINIMUM) in lost ARR from buyers who choose providers with better educational content",
                "340+ MQLs your competitors capture while your team struggles with content chaos",
                "60+ buying-intent searches where competitors rank first while you're invisible"
              ].map((point, index) => (
