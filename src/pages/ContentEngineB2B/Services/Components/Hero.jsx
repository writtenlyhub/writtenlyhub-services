    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Your competitors are outpublishing you 10:1. <span className="text-orange-500"> We fix that.</span> 
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          One retainer, unlimited requests, 5x faster delivery. Your content bottleneck just became your biggest advantage. 
          </motion.p>
