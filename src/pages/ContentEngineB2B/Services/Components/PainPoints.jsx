...
const painPoints = [
  {
    text: "We need consistent content to hit our $50M ARR goal but can't hire writers fast enough. Current team is drowning.",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "Spent three months onboarding a content manager who quit after six weeks. Meanwhile competitors publish daily while we scramble.",
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "Our content calendar shows 60% missed deadlines. Sales keeps asking where the nurture content is and I have no answers.",
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Board wants content-driven growth but hiring good B2B writers costs $60K+ each and takes forever to find ones who get SaaS.",
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "Freelancers disappear mid-project. Agencies want $20K+ per month. AI content is garbage. What options do I actually have?",
...
const PainPoints = () => {
  ...
  return (
    <div className="font-montserrat bg-[#022150]  py-16 md:py-24  px-4 flex justify-center relative">
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight text-white mt-2 md:mt-3 mb-3 md:mb-4">
              Content bottlenecks <span className="text-orange-500">killing your pipeline targets</span>
            </h2>
          </div>
        </motion.div>
              ...
              <div className="relative h-full">
                ...
                <div className="relative z-10 px-8 py-10 md:px-12 md:py-16">
                  <div className="max-w-lg mx-auto">
                    <span className="text-sm md:text-xl p-3 font-medium text-black text-center block">
                ...
                <div 
                  ...
                  style={{ left: `calc(${getPointerPosition()} - 10px)`, transform: 'translateX(-50%)' }}
                ></div>
                <div 
                  className="absolute -bottom-12 w-4 h-4 bg-white rounded-full border border-white/20 shadow-lg"
                  style={{ left: `calc(${getPointerPosition()} - 15px)`, transform: 'translateX(-50%)' }}
                ></div>
              </div>
            </motion.div>
          </AnimatePresence>
