...
const altCards = [
  {
    ...
    points: [
      "$8K-15K per project",
      "Limited by budget/scope",
      "1-2 weeks typical",
      "Generic marketers",
      "Extra costs per type",
...
const writtenlyCard = {
  ...
  points: [
    { text: "$3K-5K unlimited requests", highlight: true },
    { text: "Unlimited blogs, social, emails" },
    { text: "2-3 days guaranteed" },
    { text: "Specialist writers only" },
    { text: "Full range included" },
    ...
    >
      ...
      <div className="w-[90%] sm:w-[80%] mx-auto mb-24 sm:mb-32 text-center relative z-50">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          Our content marketing vs. every other option{" "}
          <span className="text-orange-500 block">(Hint: we win!)</span>
        </h2>
      ...
      >
        <div className="w-[90%] sm:w-[80%] mx-auto flex flex-col lg:flex-row gap-10 lg:gap-16 items-start justify-center">
          ...
          <div className="relative flex-1 w-full sm:max-w-lg lg:max-w-xl min-h-[400px] sm:min-h-[450px]">
            {altCards.map((card, i) => (
              <div
                key={card.title}
                ref={addToRefs}
