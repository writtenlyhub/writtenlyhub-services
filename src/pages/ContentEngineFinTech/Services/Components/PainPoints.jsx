...
const painPoints = [
  {
    text: "Our payment solution is groundbreaking but our content makes it sound like every other fintech startup.",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "Compliance reviews every blog post about crypto. Publishing anything takes months because of legal concerns.",
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "Lost a $500K enterprise deal because our competitor's content made them look more credible and established.",
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Marketing team keeps asking what 'AML compliance' means. I spend more time educating than strategizing.",
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "Every content agency charges enterprise rates but delivers content that sounds like they learned fintech from TechCrunch.",
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight text-white mt-2 md:mt-3 mb-3 md:mb-4">
              Sound familiar? These are the<span className="text-orange-500"> pain points we hear every damn day </span>
            </h2>
          </div>
        </motion.div>
