        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            <div className="space-y-8">
              {[
                "15,000+ qualified visitors discovering your platform organically",
                "$2M+ in pipeline from prospects who trust companies with strong content",
                "200+ enterprise leads who research solutions through educational content first",
                "460+ first-page rankings for keywords your ideal customers search daily",
              ].map((point, index) => (
