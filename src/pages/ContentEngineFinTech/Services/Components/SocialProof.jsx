...
const stats = [
  { id: 1, name: "fintech brands scaled", value: 35, unit: "+" },
  { id: 2, name: "compliant pieces published", value: 1400, unit: "+" },
  { id: 3, name: "more qualified leads generated", value: 6, unit: "x" },
  { id: 4, name: "regulatory issues", value: 0, unit: "" },
];
  ...
  return (
    <section className="bg-[#022150] text-white py-16">
      ...
      >
        ...
        <motion.div
          variants={container}
          className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-8 relative"
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-sm md:text-xs text-white/60 uppercase tracking-wide whitespace-nowrap">
                {stat.name}
              </p>

              {/* Divider for all but first item in row */}
              {index % 4 !== 0 && (
