...
const painPoints = [
  {
    text: "I've built the best product in our space but prospects pick inferior competitors who just communicate better.",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "My competitor with half my metrics just closed a Series A because their founder has 50K LinkedIn followers.",
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "I post about our features randomly hoping something sticks, but demos stay flat.",
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Spending weekends creating content that gets 3 likes from other founders instead of qualified leads.",
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "VCs want founder-market fit but I sound like everyone else in pitch meetings.",
