...
const features = [
  {
    ...
    description: "Specialists who live and breathe startup life",
    image: "https://i.ibb.co/SDg1GNhT/icons-graphs.png" // Professional workspace / LinkedIn
  },
  {
    icon: <BarChart2 className="w-5 h-5" />,
    title: "2.1M+ LinkedIn views",
    description: "Converted to qualified prospects and partnerships",
    image: "https://i.ibb.co/wFrcfLRF/icons-graphs-2.png" // Analytics dashboard
  },
  {
    icon: <LayoutDashboard className="w-5 h-5" />,
    title: "Founder-first ",
    description: "Content strategy that speaks your audience's language ",
    image: "https://i.ibb.co/nW8WG7r/Content-psychology.png" // Notebook / planning
  },
  {
    icon: <Zap className="w-5 h-5" />,
    title: "End-to-End Solution",
    description: "Complete personal branding ecosystem, no juggling multiple agencies ",
  image: "https://i.ibb.co/xSPftz7S/CARD-2-revision.png"
  },
  {
    icon: <Clock className="w-5 h-5" />,
    title: "Automated Growth",
    description: "Lead generation on autopilot while you handle the important stuff ",
