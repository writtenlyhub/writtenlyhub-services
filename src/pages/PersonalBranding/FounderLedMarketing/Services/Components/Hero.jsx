    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Great founders don't chase leads.
          <span className="text-orange-500  sm:inline "> Leads chase them.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
I'm Astha, and I turn founders into revenue-generating machines on LinkedIn. 25+ qualified prospects monthly while you focus on building your company. 
{/* <br />
