...
const steps = [
  {
    title: "Business-focused content with zero founder ego",
    description: "While competitors bore prospects with '5am gym selfies,' I position you as the strategic thinker who solves real business problems."
  },
  {
    title: "Pre-educated prospects who understand your value",
    description: "My content strategy means demo calls convert 68% faster because leads know why you're better before they even book."
  },
  {
    title: "Network that becomes your unpaid sales team",
    description: "I build your founder authority so connections start referring qualified prospects who fit your exact ICP."
  },
  {
    title: "Consistent enterprise pipeline without cold emails",
    description: "My system books 25-30 qualified B2B demos monthly through founder positioning, not spam outreach."
  },
  {
    title: "Premium positioning that eliminates price objections",
    description: "When you're seen as THE founder expert, prospects stop asking for discounts and start asking when they can get started."
  }
];
  ...
  return (
    <section ref={containerRef} id="WhyItWorks" className="font-montserrat relative w-full bg-[#022150] py-24 overflow-hidden">
      ...
      >
          ...
          <span className="text-orange-500 ">The psychology behind </span>founder-led marketing that converts
        </h2>
      </motion.div>
      ...
      >
              <p className="pb-4">The secret? I understand B2B buyer psychology and founder positioning, not just LinkedIn algorithms. </p>
