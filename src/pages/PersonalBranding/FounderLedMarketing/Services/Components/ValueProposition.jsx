  ...
  const items = [
    {
      ...
      desc: "Transform your profile into a lead magnet that attracts qualified prospects who already want to buy from you.",
    },
    {
      title: "Content strategy that pre-sells before you pitch",
      desc: "I position you as THE expert in your space so prospects reach out asking 'when can we start?' not 'what do you do?' ",
    },
    {
      title: "Founder authority that eliminates price objections",
      desc: "When you're seen as the industry leader, prospects stop negotiating and start asking about implementation timelines. ",
    },
    {
      title: "Predictable lead flow that scales with your startup ",
      desc: "Generate 25+ qualified prospects monthly even when your ads fail and cold email gets ignored. ",
    },
    {
      title: "Done-for-you system that runs without you",
      desc: "I handle everything so you can ship features while enterprise buyers find you organically through LinkedIn. ",
    },
  ];
          ...
          <div className={`flex ${isMobile ? 'flex-col' : 'items-center justify-between'} w-full max-w-7xl px-4 ${isMobile ? 'gap-6' : 'gap-12'}`}>
            ...
            <div className={`${isMobile ? 'w-full text-center' : 'flex-1 max-w-lg'}`}>
              ...
              <h2 className={`${isMobile ? 'text-2xl' : 'text-3xl md:text-5xl'} font-bold leading-tight text-white mb-4 md:mb-6`}>
                How I turn founders into 
                <span className="text-orange-500 "> revenue-generating LinkedIn machines </span>
              </h2>

              <p className={`${isMobile ? 'text-lg' : 'text-xl'} text-white mb-6 md:mb-8`}>
My proven system for founders who want pipeline, not just pretty posts: 
              </p>
