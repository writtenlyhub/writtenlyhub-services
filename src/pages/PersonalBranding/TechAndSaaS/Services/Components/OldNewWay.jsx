...
const altCards = [
  {
    title: "DIY Content Creation",
    points: [
      "Post random product updates, pray for demos",
      "Get hearts from your mom and co-founder",
      "Sacrifice weekends to create mediocre posts",
      "Sound exactly like your biggest competitor",
      "Prospects ask 'what exactly do you do?'",
      "Result: Ghost town",
    ],
  },
  {
    title: "Generic Marketing Agency",
    points: [
      "New account manager every 3 months",
      "Broad strategies that work for nobody",
      "Explain your product everytime",
      "Charge $10K for strategies that don't convert",
      "Jack-of-all-trades, master of none approach",
      "Result: Burned budget",
    ],
  },
  {
    title: "Cheap Freelancers",
    points: [
      "Templates used for 100+ other founders",
      "Mass-produced content with your logo slapped on",
      "Write about 'innovation' like it's 2015",
      "Zero understanding of technical sales cycles",
      "Churn out quantity over quality content",
      "Result: Blend into noise",
    ],
  },
];

const writtenlyCard = {
  title: "Astha's SaaS-specific system",
  points: [
    { text: "Personal branding specialists for SaaS only", highlight: false },
    { text: "30+ qualified prospects knocking down your door", highlight: false },
    { text: "Hands-off system, you focus on building", highlight: false },
    { text: "Deep SaaS expertise + LinkedIn conversion mastery", highlight: false },
    { text: "Authority that makes price objections disappear", highlight: false },
    { text: "Result: Lead magnet", highlight: false },
  ],
};
    ...
    >
      ...
      <div className="w-[90%] sm:w-[80%] mx-auto mb-12 sm:mb-32 text-center relative z-50">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          The 4 ways SaaS founders handle {" "}
          <span className="text-orange-500 block">LinkedIn LinkedIn (only 1 actually works)</span>
        </h2>
