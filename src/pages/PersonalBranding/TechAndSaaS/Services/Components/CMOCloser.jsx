      ...
      <div className="w-full max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-white text-xl md:text-2xl mb-6 max-w-4xl mx-auto">
            Right now, SaaS founders with inferior products are booking
            enterprise demos from LinkedIn daily.They're building authority
            while you're stuck explaining why your features matter.
          </p>

          <p className="text-white text-xl md:text-2xl mb-6 max-w-3xl mx-auto">
            Every month you delay costs roughly $25K in missed pipeline based on
            my client results.
          </p>

          <p className="text-white text-xl md:text-2xl mb-6 max-w-2xl mx-auto font-bold">
            I'm accepting 3 new SaaS founders this quarter. Spots fill up
