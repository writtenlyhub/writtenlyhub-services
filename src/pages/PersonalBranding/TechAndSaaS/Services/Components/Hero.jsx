    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Your SaaS won't sell itself.
          <span className="text-orange-500  sm:inline "> But your personal brand will.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
I'm Astha, and I help tech founders turn their LinkedIn into a lead generation machine. 35+ qualified demos monthly while you focus on building. 
{/* <br />
Stop explaining what you do. Start being the obvious choice.  */}
      </motion.p>
