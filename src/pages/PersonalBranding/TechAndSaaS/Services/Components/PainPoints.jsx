...
const painPoints = [
  {
    text: "I'm building the best product in our space, but nobody knows who the f*ck I am." ,
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "Spending $50K on ads while competitors get organic demos just from posting." ,
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "Every prospect says 'you're too expensive' when our ROI is 10x better." ,
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Investors want to see founder-market fit but I sound like everyone else." ,
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "I post random sh*t about our features hoping something sticks, but any real strategy goes missing." ,
...
const PainPoints = () => {
 ...
 We know your struggles
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mt-2 md:mt-3 mb-3 md:mb-4">
              The LinkedIn mistakes <span className="text-orange-500"> costing you $25K+ in pipeline monthly </span>
            </h2>
          </div>
        </motion.div>
