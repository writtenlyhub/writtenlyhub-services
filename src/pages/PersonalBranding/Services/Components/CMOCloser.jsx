      ...
      <div className="w-full max-w-6xl mx-auto text-center">
        ...
        >
          <h3 className="text-orange-500 font-bold text-3xl md:text-5xl mb-6">
            Your last chance to own the coming quarter!
          </h3>

          <p className="text-white text-xl md:text-2xl mb-6 max-w-2xl mx-auto">
            Competitors are booking calls while you're creating content.
          </p>

          <p className="text-white text-xl md:text-2xl mb-6 max-w-2xl mx-auto">
            Every delay = more missed leads and lost authority.
          </p>
            ...
            className="inline-block px-12 py-4 bg-orange-500 cursor-pointer hover:bg-white text-white text-md  hover:text-orange-500 font-semibold rounded-full transition-colors duration-700"
              >
                <span className="flex items-center">
                  Book now, get priority calendars.
