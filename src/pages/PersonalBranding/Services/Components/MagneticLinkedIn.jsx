    ...
    <section id="MagnaticLinkedIn" className="bg-[#022150] py-24 font-montserrat overflow-hidden relative">
      ...
      <div className="w-[80%] mx-auto max-w-6xl">
        ...
        <div className="text-center mb-20 relative z-30">
          ...
          >
            We make your LinkedIn so magnetic, <span className="text-orange-500 block">competitors start copying you</span>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {[
            {
              title: "Generate MQL while you sleep",
              desc: "Authority-building content that makes prospects slide into your DMs while you're planning your next vacation."
            },
            {
              title: "Triple your consultation bookings",
              desc: "LinkedIn system that turns scrollers into $50K+ contracts without pushy sales tactics."
            },
            {
              title: "Reclaim 20+ hours weekly",
              desc: "Complete LinkedIn management so you focus on serving clients while leads flow automatically."
            },
            {
              title: "Track metrics that fill your calendar",
              desc: "Performance data showing what really counts: leads, calls, and clients."
            },
            {
              title: "Command premium rates",
              desc: "LinkedIn presence so strong, you'll wonder why you ever charged less."
            },
            {
              title: "Eliminate content guesswork",
              desc: "Data-driven strategy that removes the 'what should I post' dilemma forever."
            }
          ].map((item, i) => (
            <motion.div
              key={i}
