    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Smart coaches build personal brands. 
          <span className="text-orange-500  sm:inline "> Brilliant ones let us do it!</span>
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
Get 15+ MQL monthly while you build your consulting empire. Our done-for-you LinkedIn management makes you the obvious choice in your space.        </motion.p>
