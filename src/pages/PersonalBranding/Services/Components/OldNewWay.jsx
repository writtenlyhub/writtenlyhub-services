...
const altCards = [
  {
    title: "DIY Posting",
    points: [
      "Post randomly, hope for leads",
      "2-3 likes from other coaches",
      "Burn 15+ hours weekly creating content",
      "Sound like everyone else in your space",
      "Result: Crickets",
    ],
  },
  {
    ...
    points: [
      ...
      "Inconsistent voice, zero strategy",
      "Vanity metrics with no real leads",
      "Pay per post with no guarantee",
      "Result: Frustration",
    ],
  },
  {
    ...
    points: [
      "Cookie-cutter content for everyone",
      "Explain your niche every single time",
      "Generic 'thought leadership' posts",
      "Broad marketing knowledge, no coach expertise",
      "Result: Mediocre",
    ],
  },
];
...
const writtenlyCard = {
  title: "The New Way",
  points: [
    { text: "WrittenlyHub", highlight: true },
    { text: "LinkedIn-only specialists who get coaches", highlight: false },
    { text: "15+ qualified leads monthly", highlight: false },
    { text: "Done-for-you system, 30-minute investment", highlight: false },
    { text: "Coach psychology + LinkedIn mastery", highlight: false },
    { text: "Result: Lead machine", highlight: false },
  ],
};
    ...
    >
      ...
      <div className="w-[90%] sm:w-[80%] mx-auto mb-12 sm:mb-32 text-center relative z-50">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          Why Most Coaches Fail at LinkedIn{" "}
          <span className="text-orange-500 block">(And How We Fix It)</span>
        </h2>
