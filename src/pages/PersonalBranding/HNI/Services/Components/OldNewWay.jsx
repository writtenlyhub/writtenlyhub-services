...
const altCards = [
  {
    title: "Going solo",
    points: [
      "Wing it with occasional posts",
      "Only your network sees your content",
      "Sacrifice weekends for content creation",
  ...
  },
  {
    ...
    points: [
      "New team every few months",
      "Mixed messaging, no direction",
      "Start over explaining wealth management",
      "Pay monthly with questionable ROI",
  ...
  },
  {
    ...
    points: [
      "Template content for all industries",
      "Metrics that don't translate to deals",
      "Business advice that sounds like everyone else",
      "General business knowledge, zero HNI insight",
      "Result: Looks cheap",
    ],
  },
  {
    title: "My strategic visibility system",
    points: [
      "Specialists who speak your language",
      "8-12 qualified prospects monthly",
      "Strategic system, 90% hands-off",
      "Wealth sector expertise + proven LinkedIn results",
      "Result: Deal magnet",
    ],
  },
];
