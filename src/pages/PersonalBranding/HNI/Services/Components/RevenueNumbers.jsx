      ...
      <div className="mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight text-white mt-2 md:mt-3 mb-3 md:mb-4">
            ...
            <span className="text-orange-500 ">your intangible asset</span>
          </h2>
        </div>
        ...
        <div className="text-center">
          <button
            ...
            className="inline-block px-12 py-4 mt-12 bg-orange-500 cursor-pointer hover:bg-white text-white text-md  hover:text-orange-500 font-semibold rounded-full transition-colors duration-700"
          >
