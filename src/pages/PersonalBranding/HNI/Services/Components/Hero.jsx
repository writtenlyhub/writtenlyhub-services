    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-orange-500  sm:inline "> Your LinkedIn whispers. </span>
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ opacity: isMobile ? 1 : opacity }}
        >
I help high-net-worth leaders become the industry voices that peers listen to and media quote.  
<br />
Stop being the best-kept secret in your sector. 
      </motion.p>
