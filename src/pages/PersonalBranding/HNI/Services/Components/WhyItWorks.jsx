...
const steps = [
  {
    title: "Business-focused content with zero feature dumps",
    description: "Your LinkedIn attracts qualified prospects while competitors bore people with API documentation."
  },
  {
    title: "Pre-educated prospects who understand your value",
    description: "Demo calls convert 60% faster because leads already know why your solution beats alternatives."
  },
  {
    title: "Network that becomes your unpaid sales team",
    description: "I build your authority so connections start referring qualified prospects who fit your exact ICP."
  },
  {
    title: "Consistent demo pipeline without cold emails",
    description: "My system books 25-35 qualified B2B demos monthly while you focus on shipping features that matter."
  },
  {
    title: "Authority that makes price objections disappear",
    description: "When you're seen as THE expert, prospects stop asking for discounts and start asking when they can get started."
  }
];
  ...
  return (
    <section ref={containerRef} id="WhyItWorks" className="font-montserrat relative w-full bg-[#022150] py-24 overflow-hidden">
      ...
      >
          ...
          <span className="text-orange-500 ">The SaaS content </span>formula that converts
        </h2>
      </motion.div>
