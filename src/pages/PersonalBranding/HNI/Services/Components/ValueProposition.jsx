...
const ValueProposition = () => {
 ...
 const items = [
  {
    title: "Strategic thought leadership positioning",
    desc: "I position you as the industry expert you already are, attracting media requests and speaking opportunities.",
  },
  {
    title: "Calculated content strategy",
    desc: "Share insights that build authority while maintaining the discretion your position requires.",
  },
  {
    title: "Premium network expansion",
    desc: "Connect with other industry leaders and decision-makers who value your perspective.",
  },
  {
    title: "Media relationship building",
    desc: "Become the go-to expert journalists call for commentary on industry trends.",
  },
  {
    title: "Reputation amplification system",
    desc: "Turn your existing expertise into visible thought leadership that opens doors.",
  },
];
            ...
            <div className={`${isMobile ? 'w-full text-center' : 'flex-1 max-w-lg'}`}>
              ...
              <h2 className={`${isMobile ? 'text-2xl' : 'text-3xl md:text-5xl'} font-bold leading-tight text-white mb-4 md:mb-6`}>
               Why high net worth individuals 
                <span className="text-orange-500 ">  choose our approach  </span>
              </h2>
