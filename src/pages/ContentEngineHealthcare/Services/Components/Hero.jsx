...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo - Adjusted spacing to match */}
        <motion.div 
          variants={fadeInUp} 
          className="mb-4 w-[80%]"
        ...
        {/* Headline - Adjusted spacing */}
        <motion.h1
          variants={fadeInUp}
          className="text-3xl sm:text-4xl md:text-5xl lg:text-[46px] font-semibold leading-tight sm:leading-tight mb-4 text-left w-[80%]"
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Stop explaining medical procedures to writers <span className="text-orange-500"> who think HIPAA is a yoga pose</span>
        </motion.h1>

        {/* Subtext - Adjusted spacing and text size */}
        <motion.p
          variants={fadeInUp}
          className="text-white/90 text-lg sm:text-xl mb-6 text-left w-[80%]"
          style={{ opacity: isMobile ? 1 : opacity }}
        >
          Get unlimited healthcare content that builds trust and drives appointments. Side effects include: 3x the leads, 62% cost reduction, and permanent content relief.
        </motion.p>

        {/* CTA with social proof - Adjusted spacing */}
        <motion.div 
          variants={fadeInUp} 
        ...
        >
          ...
          {/* Social proof with exact spacing from personal branding */}
