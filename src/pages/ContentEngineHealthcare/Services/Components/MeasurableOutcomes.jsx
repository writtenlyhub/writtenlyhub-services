    ...
    <section className="font-montserrat relative w-full bg-[#022150] py-12 md:py-20 overflow-hidden">
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4 leading-tight">
          <span className="text-orange-500">The content advantage you're not using </span>
        </h2>
        <p className="text-gray-300 max-w-2xl mx-auto text-xl">
          Every month without consistent healthcare content, your brand loses:
        </p>
      </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            <div className="space-y-8">
              {[
                "600+ potential prospects researching conditions online who never discover your expertise",
                "$500,000+ in treatment revenue to providers who educate patients better through content",
                "150+ referral opportunities from your audience who share competitors' helpful health guides instead",
                "160+ medical authority rankings competitors claim while your insights remain unpublished",
              ].map((point, index) => (
          ...
          >
            <div className="relative rounded-xl overflow-hidden border-2 border-orange-400/30 hidden md:block">
              <img
                src="https://i.ibb.co/8LgzGgQ9/Untitled-design-39.png"
