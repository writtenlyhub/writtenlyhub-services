...
const painPoints = [
  {
    text: "Our medical procedures sound too complex online. Patients call confused or don't show up for appointments.",
    image: "https://i.ibb.co/cXXDGQg8/1.png"
  },
  {
    text: "Compliance reviews every blog post. Publishing anything takes weeks because of legal concerns.",
    image: "https://i.ibb.co/R4GvKWx3/2.png"
  },
  {
    text: "Marketing team keeps asking what 'contraindications' means. I spend more time teaching than treating.",
    image: "https://i.ibb.co/8ghycmd3/3.png"
  },
  {
    text: "Content writers use WebMD as their medical reference. Our credibility suffers.",
    image: "https://i.ibb.co/S4KkBJQC/4.png"
  },
  {
    text: "Every agency charges $15K+ per month but delivers content that sounds like medical textbooks.",
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight text-white mt-2 md:mt-3 mb-3 md:mb-4">
              Healthcare content challenges<span className="text-orange-500"> every practice faces </span>
            </h2>
          </div>
        </motion.div>
