...
const stats = [
  { id: 1, name: 'healthcare brands partnered with', value: 15, unit: '+' },
  { id: 2, name: 'healthcare professionals and patients reached', value: 340, unit: 'K+' },
  { id: 3, name: 'pages ranking #1 for medical terms', value: 285, unit: '+' },
  { id: 4, name: 'increase in qualified conversions', value: 86, unit: '%' },
];
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight text-white mt-2 md:mt-3 mb-3 md:mb-4">
             The teams that were <span className="text-orange-500">blessed with our content retainer </span>
            </h2>
          </div>
        </motion.div>
      <motion.div
